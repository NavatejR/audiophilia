...
#ifndef AUDIOPHILIA_SWIFT_H
#define AUDIOPHILIA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Audiophilia",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// SwiftUI’s <code>.windowStyle(.hiddenTitleBar)</code> alone still paints an opaque
/// grey strip over the top ~28pt for the traffic lights. The titlebar is
/// therefore removed ENTIRELY (<code>.titled</code> is dropped) and the SwiftUI root
...
SWIFT_CLASS("_TtC11Audiophilia22AudiophiliaAppDelegate")
@interface AudiophiliaAppDelegate : NSObject <NSApplicationDelegate>
...
/// Manages the floating picture-in-picture mini player <code>NSPanel</code>.
...
/// <ul>
///   <li>
///     The <code>NSHostingView</code> is created ONCE and reused across show/hide
///     cycles — toggling the mini player never rebuilds the SwiftUI tree.
///   </li>
///   <li>
///     Present/dismiss uses an AppKit <code>NSAnimationContext</code> fade+scale
///     transform instead of an instant <code>orderFront</code>/<code>orderOut</code>.
///   </li>
/// </ul>
SWIFT_CLASS("_TtC11Audiophilia25MiniPlayerPanelController")
@interface MiniPlayerPanelController : NSObject <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
